...
import fetchPostContent from "../../redux/thunk/postContent/fetchJPostContent";
...
export default function AddContent() {
  ...
  const handelSubmit = (e) => {
    e.preventDefault();
    console.log(value);
    dispatch(fetchPostContent(value));
  };
  return (
    <div className="ml-2">
      <form onSubmit={handelSubmit}>
        <div className="flex items-center">
          ...
          />
          <br />
          <label htmlFor="contentImage" className="mx-3">
            ContentUrl
          </label>
          <br />
          <input
          ...
          />
          <br />
          <label htmlFor="author" className="mx-3">
            Author
          </label>
          <br />
          <input
        ...
        <div className="flex items-center">
          ...
          />
          <br />
          <label htmlFor="raging" className="mx-3">
            Rating
          </label>
          <br />
          <input
